...
public abstract class Command extends CommandData {
     ...
     */
    public static MessageEmbed getErrorEmbed(String title, String fieldTitle, String fieldValue) {
     ...
     * @return A MessageEmbed object
     */
    public static MessageEmbed getSuccessEmbed(String title, String fieldTitle, String fieldValue) {
        return new EmbedBuilder()
